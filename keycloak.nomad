...
KC_CACHE=local
KC_DB=mysql
KC_FEATURES_DISABLED=kerberos,admin-fine-grained-authz,ciba,client-policies,device-flow,par,step-up-authentication,persistent-user-sessions,organization,opentelemetry,token-exchange-standard,rolling-updates,user-event-metrics
