...
KC_FEATURES_DISABLED=kerberos,authorization,admin-fine-grained-authz,ciba,client-policies,device-flow,par,step-up-authentication,step-up-authentication-saml,persistent-user-sessions,organization,opentelemetry,token-exchange-standard,user-event-metrics,identity-brokering-api,jwt-authorization-grant,kubernetes-service-accounts,recovery-codes,update-email
