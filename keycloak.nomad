...
KC_FEATURES_DISABLED=kerberos,authorization,admin-fine-grained-authz,ciba,client-policies,device-flow,par,step-up-authentication,persistent-user-sessions,organization,opentelemetry,token-exchange-standard,user-event-metrics
